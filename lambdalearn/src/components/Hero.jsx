        ...
        <section className="bg-gray-900 h-screen">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto">
                <div className="mr-auto">
                    ...
                    <p className="max-w-2xl mb-6 font-light text-xl text-gray-300">Trending free-to-use Github Repos for learning software engineering and computer science.</p>
